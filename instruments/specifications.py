...
from RiVaPy.tools.datetools import \
    Period, \
    Schedule, \
    check_start_before_end as _check_start_before_end, \
    datetime_to_date_list as _datetime_to_date_list, \
    is_ascending_date_list as _is_ascending_date_list, \
    tenor_to_period as _tenor_to_period
    ...
    def from_master_data(cls, obj_id: str,
        ...
        Args:
            ...
            coupon (float): Annualised coupon amount as fraction of notional, e.g. 0.0125 for fixed rate coupon of
                            1.25%.
            tenor: (_Union[period, str]): Time distance between two coupon payment dates.
            ...
            calendar (_Union[__HolidayBase, str], optional): Holiday calendar defining the bank holidays of a country or
...
class FloatingRateNote(Bond):
    def __init__(self, obj_id: str,
        ...
        Args:
            coupon_period_dates (_List[_Union[date, datetime]): Floating rate note's coupon periods, i.e. beginning and
            ...
            spreads (_List[float], optional): List of spreads added to the floating rates derived from fixing the
